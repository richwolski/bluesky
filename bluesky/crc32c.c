 ...
 *
 * This file implements the Castagnoli CRC-32 computation, and is taken from
 * crypto/crc32c.c in the Linux kernel:
 *
 ...
 * any later version.
 *
 * Adapted by Michael Vrable to fit with BlueSky.
 */
